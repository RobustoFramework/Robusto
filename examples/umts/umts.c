#include "umts.h"
#if defined(CONFIG_ROBUSTO_UMTS_EXAMPLE_SMS) || defined(CONFIG_ROBUSTO_UMTS_EXAMPLE_MQTT) || defined(CONFIG_ROBUSTO_UMTS_EXAMPLE_GOOGLE_DRIVE) || defined(CONFIG_ROBUSTO_UMTS_EXAMPLE_NTP) 
