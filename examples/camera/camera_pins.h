...
#define LOW 0
#define HIGH 1
#define LAMP_DEFAULT 100

#if defined(CONFIG_CAMERA_MODEL_AI_THINKER)
  //
  // AI Thinker
...
#elif defined(CONFIG_CAMERA_MODEL_WROVER_KIT)
  //
  // ESP WROVER
...
#elif defined(CONFIG_CAMERA_MODEL_ARDUCAM_ESP32S_UNO)
