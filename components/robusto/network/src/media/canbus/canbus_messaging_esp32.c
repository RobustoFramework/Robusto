...
*/
    ...
    ROB_LOGW(canbus_messaging_log_prefix, "Parsed packet count %u", packet_count_index);
    ...
    else
    {
        ...
        ROB_LOGW(canbus_messaging_log_prefix, "Parsed packet index %u", packet_count_index);
