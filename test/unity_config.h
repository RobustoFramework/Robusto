...
void put_stm32(char c);

#define UNITY_OUTPUT_CHAR(a)                    put_stm32(a) 

#endif

//#define UNITY_OUTPUT_CHAR_HEADER_DECLARATION    Serial.print(int)
//#define UNITY_OUTPUT_FLUSH()                    RS232_flush() 
//#define UNITY_OUTPUT_FLUSH_HEADER_DECLARATION   RS232_flush(void) 
//#define UNITY_OUTPUT_START()                    Serial.begin(115200,1,8,0) 
